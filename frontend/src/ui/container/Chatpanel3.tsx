...
export function Chatpanel3({
  ...
  return (
    <div className="flex flex-col h-full min-h-0 flex-1 overflow-hidden bg-base-200 relative">
      {/* カレンダー*/}
      <div className="flex-1 min-h-0">
        <Calendar />
      </div>
      {isChatOpen && (
        <div className="flex flex-col shrink-0 bg-secondary relative z-10 pt-10">
          <button
          ...
          <div className="h-[30vh] max-h-[30vh] overflow-y-auto relative p-4">
